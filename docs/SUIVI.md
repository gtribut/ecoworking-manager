...
| C2.4 | Policies Eloquent (isolation données membre A/B) + tests `AuthorizationTest` | ⬜ | CLAUDE.md §3.1 — **critique** |
| C2.5 | Rôles & permissions Spatie (gates, middleware rôle) | 🚧 | Rôles seedés ; gates/policies à câbler |
